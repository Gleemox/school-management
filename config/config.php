...
// ADMIN_URL is defined by the path : isset(url)
define("ADMIN_URL", isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off' ? 'https://' : 'http://' . $_SERVER['HTTP_HOST'] . "/school_management/");
const BASE_URL = ADMIN_URL . 'index.php?'; // constant defined by a concatenation of ADMIN_URL and index.php
...
// success/error messages saved as constants for further use
